...
const ACTIVITY_MULTIPLIERS: Record<UserStats['activityLevel'], number> = {
  sedentary: 1.2,
  light: 1.375,
  moderate: 1.55,
  very: 1.725,
...
const ACTIVITY_LABELS: Record<UserStats['activityLevel'], string> = {
...
const ACTIVITY_SHORT: Record<UserStats['activityLevel'], string> = {
  sedentary: 'Sedentary',
...
function calculateTargets(stats: UserStats) {
  ...
  const calorieTarget = Math.max(1200, tdee - 400) // 400 kcal moderate deficit, floor at 1200
